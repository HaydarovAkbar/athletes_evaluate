    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.PositiveBigIntegerField(validators=[django.core.validators.RegexValidator(code='invalid_password', message='Enter a valid password in the format 1234567654', regex='^[1-9]+$')])),
